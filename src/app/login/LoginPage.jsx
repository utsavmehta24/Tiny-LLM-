...
const LoginPage = () => {
  ...
  const handleLoginData = async (e) => {
    ...
    if (!email.trim()) {
      return toast.warning("Email is required", { position: "top-center" });
    }
    if (!emailRegex.test(email)) {
      return toast.warning("Email is not valid", { position: "top-center" });
    }
    if (!password) {
      return toast.warning("Password is required", { position: "top-center" });
    }
    ...
    try {
      ...
      toast.error(`Error logging in: ${err.message}`, { position: "top-center" });
    }
  };
